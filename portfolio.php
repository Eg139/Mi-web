...
<body class="portfolio">
  <div class="container-fluid">
    ...
    <div id="paquetes" class="container">
      <div class="row">
        <div class="col-lg-6 col-sm-12">
          <div class="row">
            <div class="col-12">
              <img src="imagenes/9.jpg" style="width: 100%; height: 300px;">
            </div>
          </div>
        ...
        <div class="col-lg-6 col-sm-12">
          <div class="row">
            <div class="col-12">
              <img src="imagenes/12.jpg" style="width: 100%; height: 300px;">
            </div>
          </div>
          <div class="jumbotron bg-white">
            <div class="row">
      ...
      <div class="row">
        <div class="col-lg-6 col-sm-12">
          <div class="row">
            <div class="col-12">
              <img src="imagenes/11.jpg" style="width: 100%; height: 300px;">
            </div>
          </div>
          <div class="jumbotron bg-white">
            <div class="row">
              <div class="col-12 col-sm-12">
                ...
                <h3><strong>Usuario:</strong>admin</h3>
                <h3><strong>Clave:</strong>1234</h3>
                <a href=""><button class="btn btn-lg btn-block btn-primary">Proximamente!</button></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-6 col-sm-12">
          <div class="row">
            <div class="col-12">
              <img src="imagenes/10.jpg" style="width: 100%; height: 300px;">
            </div>
          </div>
          <div class="jumbotron bg-white">
            <div class="row">
