    ...
    <div class="col-lg-6 col-md-12">
      <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
          <a href="https://www.instagram.com/eric.guzman00/"><i class="fab fa-github"></i></a>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
          <a href="https://www.linkedin.com/in/eric-guzmán-a75425172/"><i class="fab fa-linkedin-in"></i></a>
        </div>
      </div>
    </div>
